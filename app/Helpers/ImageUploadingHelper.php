...
class ImageUploadingHelper
{
    ...
    public static function print_image($image_path, $width = 0, $height = 0, $default_image = '/admin_assets/no-image.png', $alt_title_txt = '',$css_class='')
    {
        echo self::get_image($image_path, $width, $height, $default_image, $alt_title_txt,$css_class);
    }
    ...
    public static function get_image($image_path, $width = 0, $height = 0, $default_image = '/admin_assets/no-image.png', $alt_title_txt = '',$css_class='')
    {
        ...
        return '<img class="'.$css_class.'" src="' . $image_src . '" ' . $dimensions . ' alt="' . $alt_title_txt . '" title="' . $alt_title_txt . '">';
    }
