...

{
    ...
    public function printCompanyImage($width = 0, $height = 0,$class_image='')

    {
        ...
        return \ImgUploader::print_image("company_logos/$logo", $width, $height, '/admin_assets/no-image.png', $this->name,$class_image);
